...
class RotateScaleGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  RotateScaleGestureRecognizer({ required Object debugOwner }) : super(debugOwner: debugOwner);
  ...
  double _currentSpan = 0;
  double  _initialHorizontalSpan=0;
  double  _currentHorizontalSpan=0;
  double  _initialVerticalSpan=0;
  double  _currentVerticalSpan=0;
  _LineBetweenPointers? _initialLine;
  _LineBetweenPointers? _currentLine;
  Map<int, Offset> _pointerLocations = <int, Offset>{};
  List<int> _pointerQueue = <int>[]; // A queue to sort pointers in order of entrance
  ...
  void _updateLines() {
    ...
    } else if (_initialLine?.pointerStartId == _pointerQueue[0] &&
