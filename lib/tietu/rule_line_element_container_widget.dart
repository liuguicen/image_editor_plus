...
//          mVibrator.vibrate(VIBRATOR_DURATION_IN_RULE);
  ...
  double checkElementInXRule(DragUpdateDetails distance) {
    ...
    if (!mSelectedWg!.mIsSingeFingerMove) {
      return NOT_IN_RULE;
    }

    double elementCenterX = mSelectedWg!
        .getContentRect()
        .center
        .dx;
    double elementCenterY = mSelectedWg!
        .getContentRect()
        .center
        .dy;
    ...
    double elementLeft = mSelectedWg!
        .getContentRect()
        .left;
    ...
    double elementRight = mSelectedWg!
        .getContentRect()
        .right;
  ...
  double checkElementInYRule(DragUpdateDetails distance) {
    ...
    double elementBottom = mSelectedWg!
        .getContentRect()
        .bottom;
...
class RuleLineWidget extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    if (_mRuleLines == null || _mRuleLines.isEmpty) {
